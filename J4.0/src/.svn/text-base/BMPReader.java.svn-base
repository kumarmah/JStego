...
// Constants indicating how the data is stored
    ...
    public int height=0;
    public int width=0;
    public int[][] RArray=null;
    public int[][] GArray=null;
    public int[][] BArray=null;
    public void getBMPImage(String filename)
    throws IOException
    {
...
// stored upside-down - the bottom line is stored first.
    ...
    protected  void readRGB24(int width, int height, int pixels[],
        DataInputStream in)
    throws IOException
    {
...
// Start storing at the bottom of the array
        ...
        GArray=new int[height][width];
        BArray=new int[height][width];
