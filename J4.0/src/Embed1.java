 ...
 */
public class Embed1 implements Constants {
    ...
    public Embed1(JPEGDecoder decoder, String password, String embedinfilename, String outimageFilename) {
    ...
    public int embedData(JPEGFrame frame, double BPNZ)
            throws Throwable {
...
//
    ...
    for(int j=0;j<posBinremain[0].length;j++){
      ...
      if(initialNeg[i][j]!=finalNeg[i][j]){
       ...
       FileWriter fw1 = new FileWriter("efficiency.csv", true);
